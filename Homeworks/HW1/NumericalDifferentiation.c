...
/// @brief Calculates the numerical Jacobian of a vector valued function f with
/// the given input *vec.
...
double** numericalDerivative(VectorFunction* f, const double* vec, int n,
                             double h) {
...
/// @brief Calculates the numerical Jacobian of a vector valued function f with
/// the given input *vec. Default h is 0.0001.
/// @param *f VectorFunction struct containing functions
/// @param *vec array of numerical values
/// @param n size of the vec array
/// @return Jacobian matrix
double** numericalDerivativeDefaultH(VectorFunction* f, const double* vec,
                                     int n) {
...
int main(int argc, char const** args) {
  ...
  printf("\tExpected: df/dx = %f, df/dy = %f, df/dz = %f\n", df4_dx_expected,
         df4_dy_expected, df4_dz_expected);
  printf("\tComputed: df/dx = %f, df/dy = %f, df/dz = %f\n", jacobian4[0][0],
         jacobian4[0][1], jacobian4[0][2]);
